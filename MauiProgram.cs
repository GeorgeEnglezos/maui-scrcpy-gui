...
namespace ScrcpyGUI
{
    ...
    public static class MauiProgram
    {
        ...
        // TODO (v2 — Portfolio Option C):
        // - MVVM migration: introduce AppViewModel, bind panels via INotifyPropertyChanged
        // - Async cancellation: add CancellationToken support to RunScrcpyCommand / RunAdbCommandAsync
        // - Cross-panel messaging: replace direct panel references with WeakReferenceMessenger
        // - README.md with screenshots and build instructions
